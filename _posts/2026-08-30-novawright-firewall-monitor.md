...
**# NovaWright Firewall Monitor — Take Control of Windows Firewall** ( Being released 9/30/26)

**## Introduction**

Sometimes you need to temporarily turn off Windows Firewall. Maybe you're testing software that needs to communicate over your network. Maybe a game or application isn't connecting properly. Perhaps you're troubleshooting a network problem and need to determine whether Windows Firewall is involved.
...
One of the important features of NovaWright Firewall Monitor is its ability to remember the firewall state before a full disable. When the timer expires, the application restores the previous state.
...
When you're connected to a public network, such as Wi-Fi at:
...
turning off the Public firewall profile can significantly reduce your protection. NovaWright Firewall Monitor warns you when you're taking this step.
